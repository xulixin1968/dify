          ...
          <div className="flex h-full flex-col">
            <div className='relative flex h-[200px] grow pt-14'>
                ...
                <div className='flex h-14 items-center justify-between px-6'>
                  <div className='flex items-center'>
                    ...
                    <div className='flex h-[14px] items-center space-x-1 text-xs'>
                      {isAdvancedMode && (
                        <div className='border-components-button-secondary-border system-xs-medium-uppercase text-text-tertiary ml-1 flex h-5 items-center rounded-md border px-1.5 uppercase'>{t('appDebug.promptMode.advanced')}</div>
                      )}
                    </div>
                  </div>
                  <div className='flex items-center'>
                    ...
                    {isMobile && (
                      <Button className='mr-2 !h-8 !text-[13px] font-medium' onClick={showDebugPanel}>
                        ...
                        <CodeBracketIcon className="text-text-tertiary h-4 w-4" />
                      </Button>
                    )}
                    <AppPublisher {...{
              ...
              {!isMobile && <div className="relative flex h-full w-1/2 grow flex-col overflow-y-auto " style={{ borderColor: 'rgba(0, 0, 0, 0.02)' }}>
                <div className='border-components-panel-border bg-chatbot-bg flex grow flex-col rounded-tl-2xl border-l-[0.5px] border-t-[0.5px] '>
                  <Debug
